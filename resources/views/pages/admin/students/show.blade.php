<x-layout.app :title="'Detail Siswa'">
    @push('styles')
    <style>
        * {
            margin: 0;
    ...
    <nav class="navbar">
        <div class="navbar-content">
            <h1>Detail Siswa</h1>
            <a href="{{ route('admin.students') }}" class="btn-back">← Kembali</a>
        </div>
    </nav>
                ...
                <div class="profile-section">
                    ...
                    <div class="profile-grid">
                        ...
                        <div class="profile-item">
                            ...
                            <div class="value">{{ $student->gender ? ucfirst($student->gender) : '-' }}</div>
                        </div>
                        <div class="profile-item">
                        ...
                        <div class="profile-item">
                            ...
                            <div class="value">
                                @if($student->date_of_birth)
                                    {{ \Carbon\Carbon::parse($student->date_of_birth)->age }} tahun
                                @else
                                    -
                                @endif
                            </div>
                ...
                <div class="profile-section">
                    ...
                    <div class="user-info">
                        <div class="profile-grid">
                            ...
                            <div class="profile-item">
                                <label>Role</label>
                                <div class="value">{{ ucfirst($student->user->roles->first()?->name ?? '-') }}</div>
                            </div>
                            <div class="profile-item">
                                <label>Terdaftar</label>
                                <div class="value">{{ $student->created_at->format('d F Y') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
